...
COMSCORE.SiteRecruit.Broker.config={version:"5.0.3",testMode:false,cookie:{name:"msresearch",path:"/",domain:".microsoft.com",duration:90,rapidDuration:0,expireDate:""},thirdPartyOptOutCookieEnabled:false,prefixUrl:"",Events:{beforeRecruit:function(){}},mapping:[{m:"(code\\.msdn\\.microsoft\\.com|cpapp02)/(WINDOWSAPPS|WINDOWSDESKTOP|WINDOWSHARDWARE|IE)",c:"inv_c_BLANK.js",f:0,p:2,halt:true},{m:"^http(s)?\\:\\/\\/account\\.microsoft-int\\.com",c:"inv_c_ACCOUNT-INT.js",f:100,p:1,prereqs:{content:[],cookie:[{'name':'tstMode','value':'1'}],externalDomain:[]}},{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/ja-jp",c:"inv_c_MSDN-p15466742-JA.js",f:0.0063,p:0},{m:"(.*?social\\.msdn\\.microsoft)[\\w\\.-/]+/forums/en-(us|US)/category/(windowsdesktopdev|windowshardwaredev|iedevelopment|windowsapps)",c:"inv_c_BLANK.js",f:0,p:3,halt:true},{m:"/(sr-technet|tnstage|tnlive|tntest|technet\\.microsoft)[\\w\\.-]+/ja-jp",c:"inv_c_TECHNET-p15466742-p81712691-JA.js",f:0.0093,p:1}]};
